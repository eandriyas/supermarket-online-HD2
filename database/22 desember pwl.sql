...
insert  into `admin`(`id_admin`,`username`,`password`,`nama_admin`,`last_login`) values (1,'admin','21232F297A57A5A743894A0E4A801FC3','admin_pwl','2013-12-22 06:54:25');
...
CREATE TABLE `beli` (
  `no_beli` int(20) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `beli_ibfk_2` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`) ON DELETE CASCADE ON UPDATE CASCADE
